...
class SetCriterion(nn.Module):
    ...
    def __init__(self, num_classes, matcher, weight_dict, eos_coef, losses,
        ...
        self.losses = losses
        self.device = device
        empty_weight = torch.ones(self.num_classes).to(device)#todo self.num_classes + 1
    ...
    def loss_labels(self, outputs, targets, indices, num_masks):
        ...
        target_classes = torch.full(src_logits.shape[:2], 0, dtype=torch.int64, device=src_logits.device)#为什么是0?
